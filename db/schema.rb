...
ActiveRecord::Schema.define(:version => 20130430111356) do
  ...
  create_table "locations", :force => true do |t|
    ...
    t.string   "phone"
    t.string   "website"
    t.decimal  "sales_tax",            :precision => 6,  :scale => 3, :default => 0.0,     :null => false
    t.decimal  "minimum_total",        :precision => 10, :scale => 2, :default => 0.0,     :null => false
    t.decimal  "delivery_fee",         :precision => 11, :scale => 3, :default => 0.0,     :null => false
    t.string   "delivery_fee_type",                                   :default => "fixed", :null => false
    t.string   "order_options",                                       :default => "both",  :null => false
    t.decimal  "max_distance",         :precision => 11, :scale => 3, :default => 5.0,     :null => false
    t.string   "timezone"
  ...
  create_table "options", :force => true do |t|
    t.string  "name",                                                            :null => false
    t.string  "description"
    t.decimal "extra",           :precision => 10, :scale => 2, :default => 0.0, :null => false
    t.integer "option_group_id"
  end
  ...
  create_table "orders", :force => true do |t|
    ...
    t.decimal  "sales_tax",    :precision => 11, :scale => 3,                    :null => false
